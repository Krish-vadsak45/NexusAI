...
export function VideoRepurposer() {
  ...
  const [result, setResult] = useState<VideoRepurposerResult | null>(null);
  ...
  const handleUploadSuccess = (result: CloudinaryUploadWidgetResults) => {
    ...
    if (!info || typeof info === "string" || Array.isArray(info)) {
      toast.error("Cloudinary upload did not return video details");
      return;
    }
    ...
    if (
      ...
      toast.error("Cloudinary upload returned incomplete video details");
      return;
    }

    setVideoUrl(info.secure_url);
    setVideoName(info.original_filename);
