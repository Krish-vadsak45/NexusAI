  ...
  return (
    <section className="container mx-auto px-6 py-20 md:px-8 md:py-32 lg:px-12 relative">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="mx-auto max-w-3xl text-center mb-12 sm:mb-16 md:mb-24"
      >
        <h2 className="text-balance text-3xl font-extrabold tracking-tight md:text-5xl lg:text-6xl bg-clip-text text-transparent bg-linear-to-r from-white via-white to-white/60">
          Supercharge your workflow
        </h2>
        <p className="mt-4 sm:mt-6 text-pretty text-base sm:text-lg text-gray-400 md:text-xl max-w-2xl mx-auto px-4">
      ...
      >
        {plans.map((plan) => {
          ...
          if (isCurrentPlan) {
            ...
            cardClassName +=
              "border-purple-500/50 shadow-[0_0_40px_rgba(168,85,247,0.15)] md:scale-105 z-10";
          } else {
