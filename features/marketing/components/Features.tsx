  ...
  return (
    <section className="container mx-auto px-6 py-24 md:px-8 md:py-40 lg:px-12 relative">
      ...
      >
        ...
        <h2 className="text-balance text-4xl font-black tracking-tight sm:text-6xl lg:text-7xl bg-linear-to-b from-white to-white/50 bg-clip-text text-transparent">
          Built for the Future
        </h2>
        <p className="mt-6 sm:mt-8 text-pretty text-lg sm:text-xl text-gray-400 font-medium leading-relaxed px-4">
      ...
      >
        {features.map((feature, idx) => (
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-black/50 p-8 sm:p-10 backdrop-blur-3xl transition-all duration-500 lg:p-14 h-full flex flex-col items-start hover:border-white/10">
